...
import type { Bytes, Compact, Null, Option, Result, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from '@polkadot/types-codec';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetRegistry: {
       ...
       **/
      AssetRegistered: AugmentedEvent<ApiType, [assetId: TanglePrimitivesCurrencyAssetIds, metadata: TangleAssetRegistryAssetMetadata], { assetId: TanglePrimitivesCurrencyAssetIds, metadata: TangleAssetRegistryAssetMetadata }>;
      /**
       * The asset updated.
       **/
      AssetUpdated: AugmentedEvent<ApiType, [assetId: TanglePrimitivesCurrencyAssetIds, metadata: TangleAssetRegistryAssetMetadata], { assetId: TanglePrimitivesCurrencyAssetIds, metadata: TangleAssetRegistryAssetMetadata }>;
      /**
       * The CurrencyId registered.
       **/
      CurrencyIdRegistered: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, metadata: TangleAssetRegistryAssetMetadata], { currencyId: TanglePrimitivesCurrencyCurrencyId, metadata: TangleAssetRegistryAssetMetadata }>;
      /**
       * MultiLocation Force set.
       **/
      MultiLocationSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, location: StagingXcmV3MultiLocation, weight: SpWeightsWeightV2Weight], { currencyId: TanglePrimitivesCurrencyCurrencyId, location: StagingXcmV3MultiLocation, weight: SpWeightsWeightV2Weight }>;
      /**
       * Generic event
       **/
    ...
    lstMinting: {
      CurrencyTimeUnitRecreated: AugmentedEvent<ApiType, [tokenId: TanglePrimitivesCurrencyCurrencyId, timeUnit: TanglePrimitivesTimeUnit], { tokenId: TanglePrimitivesCurrencyCurrencyId, timeUnit: TanglePrimitivesTimeUnit }>;
      ...
      MinimumMintSet: AugmentedEvent<ApiType, [tokenId: TanglePrimitivesCurrencyCurrencyId, amount: u128], { tokenId: TanglePrimitivesCurrencyCurrencyId, amount: u128 }>;
      MinimumRedeemSet: AugmentedEvent<ApiType, [tokenId: TanglePrimitivesCurrencyCurrencyId, amount: u128], { tokenId: TanglePrimitivesCurrencyCurrencyId, amount: u128 }>;
      Minted: AugmentedEvent<ApiType, [address: AccountId32, tokenId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, lstAmount: u128, fee: u128, remark: Bytes], { address: AccountId32, tokenId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, lstAmount: u128, fee: u128, remark: Bytes }>;
      MinTimeUnitSet: AugmentedEvent<ApiType, [tokenId: TanglePrimitivesCurrencyCurrencyId, timeUnit: TanglePrimitivesTimeUnit], { tokenId: TanglePrimitivesCurrencyCurrencyId, timeUnit: TanglePrimitivesTimeUnit }>;
      Rebonded: AugmentedEvent<ApiType, [address: AccountId32, tokenId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, lstAmount: u128, fee: u128], { address: AccountId32, tokenId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, lstAmount: u128, fee: u128 }>;
      RebondedByUnlockId: AugmentedEvent<ApiType, [address: AccountId32, tokenId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, lstAmount: u128, fee: u128, unlockId: u32], { address: AccountId32, tokenId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, lstAmount: u128, fee: u128, unlockId: u32 }>;
      Redeemed: AugmentedEvent<ApiType, [address: AccountId32, tokenId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, lstAmount: u128, fee: u128, unlockId: u32], { address: AccountId32, tokenId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, lstAmount: u128, fee: u128, unlockId: u32 }>;
      RedeemSuccess: AugmentedEvent<ApiType, [unlockId: u32, tokenId: TanglePrimitivesCurrencyCurrencyId, to: AccountId32, tokenAmount: u128], { unlockId: u32, tokenId: TanglePrimitivesCurrencyCurrencyId, to: AccountId32, tokenAmount: u128 }>;
      SupportRebondTokenAdded: AugmentedEvent<ApiType, [tokenId: TanglePrimitivesCurrencyCurrencyId], { tokenId: TanglePrimitivesCurrencyCurrencyId }>;
      SupportRebondTokenRemoved: AugmentedEvent<ApiType, [tokenId: TanglePrimitivesCurrencyCurrencyId], { tokenId: TanglePrimitivesCurrencyCurrencyId }>;
      UnlockDurationSet: AugmentedEvent<ApiType, [tokenId: TanglePrimitivesCurrencyCurrencyId, unlockDuration: TanglePrimitivesTimeUnit], { tokenId: TanglePrimitivesCurrencyCurrencyId, unlockDuration: TanglePrimitivesTimeUnit }>;
      UnlockingTotalSet: AugmentedEvent<ApiType, [tokenId: TanglePrimitivesCurrencyCurrencyId, amount: u128], { tokenId: TanglePrimitivesCurrencyCurrencyId, amount: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    lstVoting: {
      DelegatorAdded: AugmentedEvent<ApiType, [lst: TanglePrimitivesCurrencyCurrencyId, derivativeIndex: u16], { lst: TanglePrimitivesCurrencyCurrencyId, derivativeIndex: u16 }>;
      DelegatorVoteRemoved: AugmentedEvent<ApiType, [who: AccountId32, lst: TanglePrimitivesCurrencyCurrencyId, derivativeIndex: u16], { who: AccountId32, lst: TanglePrimitivesCurrencyCurrencyId, derivativeIndex: u16 }>;
      DelegatorVoteRemovedNotified: AugmentedEvent<ApiType, [lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32, success: bool], { lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32, success: bool }>;
      ReferendumInfoCreated: AugmentedEvent<ApiType, [lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32, info: TangleLstVotingVoteReferendumInfo], { lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32, info: TangleLstVotingVoteReferendumInfo }>;
      ReferendumInfoSet: AugmentedEvent<ApiType, [lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32, info: TangleLstVotingVoteReferendumInfo], { lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32, info: TangleLstVotingVoteReferendumInfo }>;
      ReferendumKilled: AugmentedEvent<ApiType, [lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32], { lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32 }>;
      ResponseReceived: AugmentedEvent<ApiType, [responder: StagingXcmV3MultiLocation, queryId: u64, response: XcmV3Response], { responder: StagingXcmV3MultiLocation, queryId: u64, response: XcmV3Response }>;
      UndecidingTimeoutSet: AugmentedEvent<ApiType, [lst: TanglePrimitivesCurrencyCurrencyId, undecidingTimeout: u32], { lst: TanglePrimitivesCurrencyCurrencyId, undecidingTimeout: u32 }>;
      Unlocked: AugmentedEvent<ApiType, [who: AccountId32, lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32], { who: AccountId32, lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32 }>;
      VoteCapRatioSet: AugmentedEvent<ApiType, [lst: TanglePrimitivesCurrencyCurrencyId, voteCapRatio: Perbill], { lst: TanglePrimitivesCurrencyCurrencyId, voteCapRatio: Perbill }>;
      Voted: AugmentedEvent<ApiType, [who: AccountId32, lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32, tokenVote: TangleLstVotingVoteAccountVote, delegatorVote: TangleLstVotingVoteAccountVote], { who: AccountId32, lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32, tokenVote: TangleLstVotingVoteAccountVote, delegatorVote: TangleLstVotingVoteAccountVote }>;
      VoteLockingPeriodSet: AugmentedEvent<ApiType, [lst: TanglePrimitivesCurrencyCurrencyId, lockingPeriod: u32], { lst: TanglePrimitivesCurrencyCurrencyId, lockingPeriod: u32 }>;
      VoteNotified: AugmentedEvent<ApiType, [lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32, success: bool], { lst: TanglePrimitivesCurrencyCurrencyId, pollIndex: u32, success: bool }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    oracle: {
       ...
       **/
      NewFeedData: AugmentedEvent<ApiType, [sender: AccountId32, values: Vec<ITuple<[TanglePrimitivesCurrencyCurrencyId, u128]>>], { sender: AccountId32, values: Vec<ITuple<[TanglePrimitivesCurrencyCurrencyId, u128]>> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    parachainStaking: {
       ...
       **/
      CancelledDelegationRequest: AugmentedEvent<ApiType, [delegator: AccountId32, cancelledRequest: TangleParachainStakingDelegationRequestsCancelledScheduledRequest, collator: AccountId32], { delegator: AccountId32, cancelledRequest: TangleParachainStakingDelegationRequestsCancelledScheduledRequest, collator: AccountId32 }>;
      /**
       ...
       **/
      Delegation: AugmentedEvent<ApiType, [delegator: AccountId32, lockedAmount: u128, candidate: AccountId32, delegatorPosition: TangleParachainStakingDelegatorAdded], { delegator: AccountId32, lockedAmount: u128, candidate: AccountId32, delegatorPosition: TangleParachainStakingDelegatorAdded }>;
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: TangleKusamaRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: TangleKusamaRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: TangleKusamaRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: TangleKusamaRuntimeProxyType, delay: u32 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: TangleKusamaRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId32, who: AccountId32, proxyType: TangleKusamaRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    slp: {
      BurnFeeFailed: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, amount: u128 }>;
      Chill: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, queryId: Compact<u64>, queryIdHash: H256], { currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, queryId: Compact<u64>, queryIdHash: H256 }>;
      ConvertAsset: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: StagingXcmV3MultiLocation, amount: Compact<u128>], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: StagingXcmV3MultiLocation, amount: Compact<u128> }>;
      CurrencyDelaysSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delays: Option<TangleSlpPrimitivesDelays>], { currencyId: TanglePrimitivesCurrencyCurrencyId, delays: Option<TangleSlpPrimitivesDelays> }>;
      CurrencyTuneExchangeRateLimitSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, tuneExchangeRateLimit: Option<ITuple<[u32, Permill]>>], { currencyId: TanglePrimitivesCurrencyCurrencyId, tuneExchangeRateLimit: Option<ITuple<[u32, Permill]>> }>;
      Delegated: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, targets: Option<Vec<StagingXcmV3MultiLocation>>, queryId: Compact<u64>, queryIdHash: H256], { currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, targets: Option<Vec<StagingXcmV3MultiLocation>>, queryId: Compact<u64>, queryIdHash: H256 }>;
      DelegatorAdded: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, index: Compact<u16>, delegatorId: StagingXcmV3MultiLocation], { currencyId: TanglePrimitivesCurrencyCurrencyId, index: Compact<u16>, delegatorId: StagingXcmV3MultiLocation }>;
      DelegatorBonded: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, bondedAmount: Compact<u128>, queryId: Compact<u64>, queryIdHash: H256, validator: Option<StagingXcmV3MultiLocation>], { currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, bondedAmount: Compact<u128>, queryId: Compact<u64>, queryIdHash: H256, validator: Option<StagingXcmV3MultiLocation> }>;
      DelegatorBondExtra: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, extraBondedAmount: Compact<u128>, queryId: Compact<u64>, queryIdHash: H256, validator: Option<StagingXcmV3MultiLocation>], { currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, extraBondedAmount: Compact<u128>, queryId: Compact<u64>, queryIdHash: H256, validator: Option<StagingXcmV3MultiLocation> }>;
      DelegatorInitialized: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation], { currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation }>;
      DelegatorLedgerQueryResponseConfirmed: AugmentedEvent<ApiType, [queryId: Compact<u64>, entry: TangleSlpPrimitivesLedgerUpdateEntry], { queryId: Compact<u64>, entry: TangleSlpPrimitivesLedgerUpdateEntry }>;
      DelegatorLedgerQueryResponseFailed: AugmentedEvent<ApiType, [queryId: Compact<u64>], { queryId: Compact<u64> }>;
      DelegatorLedgerSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delegator: StagingXcmV3MultiLocation, ledger: Option<TangleSlpPrimitivesLedger>], { currencyId: TanglePrimitivesCurrencyCurrencyId, delegator: StagingXcmV3MultiLocation, ledger: Option<TangleSlpPrimitivesLedger> }>;
      DelegatorRebond: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, rebondAmount: Option<u128>, queryId: Compact<u64>, queryIdHash: H256, validator: Option<StagingXcmV3MultiLocation>], { currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, rebondAmount: Option<u128>, queryId: Compact<u64>, queryIdHash: H256, validator: Option<StagingXcmV3MultiLocation> }>;
      DelegatorRemoved: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation], { currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation }>;
      DelegatorUnbond: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, unbondAmount: Compact<u128>, queryId: Compact<u64>, queryIdHash: H256, validator: Option<StagingXcmV3MultiLocation>], { currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, unbondAmount: Compact<u128>, queryId: Compact<u64>, queryIdHash: H256, validator: Option<StagingXcmV3MultiLocation> }>;
      DelegatorUnbondAll: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, queryId: Compact<u64>, queryIdHash: H256], { currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, queryId: Compact<u64>, queryIdHash: H256 }>;
      FeeSourceSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, whoAndFee: Option<ITuple<[StagingXcmV3MultiLocation, u128]>>], { currencyId: TanglePrimitivesCurrencyCurrencyId, whoAndFee: Option<ITuple<[StagingXcmV3MultiLocation, u128]>> }>;
      FeeSupplemented: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, amount: Compact<u128>, from: StagingXcmV3MultiLocation, to: StagingXcmV3MultiLocation], { currencyId: TanglePrimitivesCurrencyCurrencyId, amount: Compact<u128>, from: StagingXcmV3MultiLocation, to: StagingXcmV3MultiLocation }>;
      FundMoveFromExitToEntrance: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, amount: Compact<u128>], { currencyId: TanglePrimitivesCurrencyCurrencyId, amount: Compact<u128> }>;
      HostingFeeCharged: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, amount: Compact<u128>], { currencyId: TanglePrimitivesCurrencyCurrencyId, amount: Compact<u128> }>;
      HostingFeesSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, fees: Option<ITuple<[Permill, StagingXcmV3MultiLocation]>>], { currencyId: TanglePrimitivesCurrencyCurrencyId, fees: Option<ITuple<[Permill, StagingXcmV3MultiLocation]>> }>;
      Liquidize: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, timeUnit: Option<TanglePrimitivesTimeUnit>, queryId: Compact<u64>, queryIdHash: H256, amount: Option<u128>], { currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, timeUnit: Option<TanglePrimitivesTimeUnit>, queryId: Compact<u64>, queryIdHash: H256, amount: Option<u128> }>;
      MinimumsMaximumsSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, minimumsAndMaximums: Option<TangleSlpPrimitivesMinimumsMaximums>], { currencyId: TanglePrimitivesCurrencyCurrencyId, minimumsAndMaximums: Option<TangleSlpPrimitivesMinimumsMaximums> }>;
      OngoingTimeUnitUpdateIntervalSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, interval: Option<u32>], { currencyId: TanglePrimitivesCurrencyCurrencyId, interval: Option<u32> }>;
      OperateOriginSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, operator: Option<AccountId32>], { currencyId: TanglePrimitivesCurrencyCurrencyId, operator: Option<AccountId32> }>;
      OutdatedValidatorBoostListCleaned: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, page: u8, removeNum: u32, numLeft: u32], { currencyId: TanglePrimitivesCurrencyCurrencyId, page: u8, removeNum: u32, numLeft: u32 }>;
      Payout: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, validator: StagingXcmV3MultiLocation, timeUnit: Option<TanglePrimitivesTimeUnit>], { currencyId: TanglePrimitivesCurrencyCurrencyId, validator: StagingXcmV3MultiLocation, timeUnit: Option<TanglePrimitivesTimeUnit> }>;
      PoolTokenDecreased: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, amount: Compact<u128>], { currencyId: TanglePrimitivesCurrencyCurrencyId, amount: Compact<u128> }>;
      PoolTokenIncreased: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, amount: Compact<u128>], { currencyId: TanglePrimitivesCurrencyCurrencyId, amount: Compact<u128> }>;
      Refund: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, timeUnit: TanglePrimitivesTimeUnit, index: Compact<u32>, amount: Compact<u128>], { currencyId: TanglePrimitivesCurrencyCurrencyId, timeUnit: TanglePrimitivesTimeUnit, index: Compact<u32>, amount: Compact<u128> }>;
      RemovedFromBoostList: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: StagingXcmV3MultiLocation], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: StagingXcmV3MultiLocation }>;
      SupplementFeeAccountWhitelistAdded: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: StagingXcmV3MultiLocation], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: StagingXcmV3MultiLocation }>;
      SupplementFeeAccountWhitelistRemoved: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: StagingXcmV3MultiLocation], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: StagingXcmV3MultiLocation }>;
      TimeUnitUpdated: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, old: Option<TanglePrimitivesTimeUnit>, new_: TanglePrimitivesTimeUnit], { currencyId: TanglePrimitivesCurrencyCurrencyId, old: Option<TanglePrimitivesTimeUnit>, new_: TanglePrimitivesTimeUnit }>;
      TransferBack: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, from: StagingXcmV3MultiLocation, to: StagingXcmV3MultiLocation, amount: Compact<u128>], { currencyId: TanglePrimitivesCurrencyCurrencyId, from: StagingXcmV3MultiLocation, to: StagingXcmV3MultiLocation, amount: Compact<u128> }>;
      TransferTo: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, from: StagingXcmV3MultiLocation, to: StagingXcmV3MultiLocation, amount: Compact<u128>], { currencyId: TanglePrimitivesCurrencyCurrencyId, from: StagingXcmV3MultiLocation, to: StagingXcmV3MultiLocation, amount: Compact<u128> }>;
      Undelegated: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, targets: Vec<StagingXcmV3MultiLocation>, queryId: Compact<u64>, queryIdHash: H256], { currencyId: TanglePrimitivesCurrencyCurrencyId, delegatorId: StagingXcmV3MultiLocation, targets: Vec<StagingXcmV3MultiLocation>, queryId: Compact<u64>, queryIdHash: H256 }>;
      ValidatorBoostListAdded: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: StagingXcmV3MultiLocation, dueBlockNumber: u32], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: StagingXcmV3MultiLocation, dueBlockNumber: u32 }>;
      ValidatorBoostListSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, validatorBoostList: Vec<ITuple<[StagingXcmV3MultiLocation, u32]>>], { currencyId: TanglePrimitivesCurrencyCurrencyId, validatorBoostList: Vec<ITuple<[StagingXcmV3MultiLocation, u32]>> }>;
      ValidatorsAdded: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, validatorId: StagingXcmV3MultiLocation], { currencyId: TanglePrimitivesCurrencyCurrencyId, validatorId: StagingXcmV3MultiLocation }>;
      ValidatorsByDelegatorQueryResponseConfirmed: AugmentedEvent<ApiType, [queryId: Compact<u64>, entry: TangleSlpPrimitivesValidatorsByDelegatorUpdateEntry], { queryId: Compact<u64>, entry: TangleSlpPrimitivesValidatorsByDelegatorUpdateEntry }>;
      ValidatorsByDelegatorQueryResponseFailed: AugmentedEvent<ApiType, [queryId: Compact<u64>], { queryId: Compact<u64> }>;
      ValidatorsByDelegatorSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, validatorsList: Vec<StagingXcmV3MultiLocation>, delegatorId: StagingXcmV3MultiLocation], { currencyId: TanglePrimitivesCurrencyCurrencyId, validatorsList: Vec<StagingXcmV3MultiLocation>, delegatorId: StagingXcmV3MultiLocation }>;
      ValidatorsRemoved: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, validatorId: StagingXcmV3MultiLocation], { currencyId: TanglePrimitivesCurrencyCurrencyId, validatorId: StagingXcmV3MultiLocation }>;
      ValidatorsReset: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, validatorList: Vec<StagingXcmV3MultiLocation>], { currencyId: TanglePrimitivesCurrencyCurrencyId, validatorList: Vec<StagingXcmV3MultiLocation> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    slpx: {
      AddWhitelistAccountId: AugmentedEvent<ApiType, [supportChain: TangleSlpxSupportChain, evmContractAccountId: AccountId32], { supportChain: TangleSlpxSupportChain, evmContractAccountId: AccountId32 }>;
      ...
      RemoveWhitelistAccountId: AugmentedEvent<ApiType, [supportChain: TangleSlpxSupportChain, evmContractAccountId: AccountId32], { supportChain: TangleSlpxSupportChain, evmContractAccountId: AccountId32 }>;
      SetCurrencyEthereumCallSwitch: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, isSupport: bool], { currencyId: TanglePrimitivesCurrencyCurrencyId, isSupport: bool }>;
      SetCurrencyToSupportXcmFee: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, isSupport: bool], { currencyId: TanglePrimitivesCurrencyCurrencyId, isSupport: bool }>;
      SetDelayBlock: AugmentedEvent<ApiType, [delayBlock: u32], { delayBlock: u32 }>;
      SetEthereumCallConfiguration: AugmentedEvent<ApiType, [xcmFee: u128, xcmWeight: SpWeightsWeightV2Weight, period: u32, contract: H160], { xcmFee: u128, xcmWeight: SpWeightsWeightV2Weight, period: u32, contract: H160 }>;
      SetExecutionFee: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, executionFee: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, executionFee: u128 }>;
      SetTransferToFee: AugmentedEvent<ApiType, [supportChain: TangleSlpxSupportChain, transferToFee: u128], { supportChain: TangleSlpxSupportChain, transferToFee: u128 }>;
      XcmMint: AugmentedEvent<ApiType, [evmCaller: H160, currencyId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, targetChain: TangleSlpxTargetChain], { evmCaller: H160, currencyId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, targetChain: TangleSlpxTargetChain }>;
      XcmMintFailed: AugmentedEvent<ApiType, [evmCaller: H160, currencyId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, targetChain: TangleSlpxTargetChain], { evmCaller: H160, currencyId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, targetChain: TangleSlpxTargetChain }>;
      XcmRedeem: AugmentedEvent<ApiType, [evmCaller: H160, lstId: TanglePrimitivesCurrencyCurrencyId, lstAmount: u128, targetChain: TangleSlpxTargetChain], { evmCaller: H160, lstId: TanglePrimitivesCurrencyCurrencyId, lstAmount: u128, targetChain: TangleSlpxTargetChain }>;
      XcmRedeemFailed: AugmentedEvent<ApiType, [evmCaller: H160, lstId: TanglePrimitivesCurrencyCurrencyId, lstAmount: u128, targetChain: TangleSlpxTargetChain], { evmCaller: H160, lstId: TanglePrimitivesCurrencyCurrencyId, lstAmount: u128, targetChain: TangleSlpxTargetChain }>;
      XcmSetTokenAmount: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, vcurrencyId: TanglePrimitivesCurrencyCurrencyId, lstAmount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, tokenAmount: u128, vcurrencyId: TanglePrimitivesCurrencyCurrencyId, lstAmount: u128 }>;
      XcmStablePoolSwap: AugmentedEvent<ApiType, [evmCaller: H160, poolTokenIndexIn: u32, poolTokenIndexOut: u32, currencyIdOutAmount: u128, targetChain: TangleSlpxTargetChain], { evmCaller: H160, poolTokenIndexIn: u32, poolTokenIndexOut: u32, currencyIdOutAmount: u128, targetChain: TangleSlpxTargetChain }>;
      XcmStablePoolSwapFailed: AugmentedEvent<ApiType, [evmCaller: H160, poolTokenIndexIn: u32, poolTokenIndexOut: u32, currencyIdInAmount: u128, targetChain: TangleSlpxTargetChain], { evmCaller: H160, poolTokenIndexIn: u32, poolTokenIndexOut: u32, currencyIdInAmount: u128, targetChain: TangleSlpxTargetChain }>;
      XcmZenlinkSwap: AugmentedEvent<ApiType, [evmCaller: H160, currencyIdIn: TanglePrimitivesCurrencyCurrencyId, currencyIdOut: TanglePrimitivesCurrencyCurrencyId, currencyIdOutAmount: u128, targetChain: TangleSlpxTargetChain], { evmCaller: H160, currencyIdIn: TanglePrimitivesCurrencyCurrencyId, currencyIdOut: TanglePrimitivesCurrencyCurrencyId, currencyIdOutAmount: u128, targetChain: TangleSlpxTargetChain }>;
      XcmZenlinkSwapFailed: AugmentedEvent<ApiType, [evmCaller: H160, currencyIdIn: TanglePrimitivesCurrencyCurrencyId, currencyIdOut: TanglePrimitivesCurrencyCurrencyId, currencyIdInAmount: u128, targetChain: TangleSlpxTargetChain], { evmCaller: H160, currencyIdIn: TanglePrimitivesCurrencyCurrencyId, currencyIdOut: TanglePrimitivesCurrencyCurrencyId, currencyIdInAmount: u128, targetChain: TangleSlpxTargetChain }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    stableAsset: {
      ...
      RedeemedSingle: AugmentedEvent<ApiType, [redeemer: AccountId32, poolId: u32, a: u128, inputAmount: u128, outputAsset: TanglePrimitivesCurrencyCurrencyId, minOutputAmount: u128, balances: Vec<u128>, totalSupply: u128, feeAmount: u128, outputAmount: u128], { redeemer: AccountId32, poolId: u32, a: u128, inputAmount: u128, outputAsset: TanglePrimitivesCurrencyCurrencyId, minOutputAmount: u128, balances: Vec<u128>, totalSupply: u128, feeAmount: u128, outputAmount: u128 }>;
      TokenRateHardcapConfigured: AugmentedEvent<ApiType, [lst: TanglePrimitivesCurrencyCurrencyId, hardcap: Permill], { lst: TanglePrimitivesCurrencyCurrencyId, hardcap: Permill }>;
      TokenRateHardcapRemoved: AugmentedEvent<ApiType, [lst: TanglePrimitivesCurrencyCurrencyId], { lst: TanglePrimitivesCurrencyCurrencyId }>;
      TokenRateRefreshFailed: AugmentedEvent<ApiType, [poolId: u32], { poolId: u32 }>;
      TokenRateSet: AugmentedEvent<ApiType, [poolId: u32, tokenRate: Vec<ITuple<[TanglePrimitivesCurrencyCurrencyId, ITuple<[u128, u128]>]>>], { poolId: u32, tokenRate: Vec<ITuple<[TanglePrimitivesCurrencyCurrencyId, ITuple<[u128, u128]>]>> }>;
      TokenSwapped: AugmentedEvent<ApiType, [swapper: AccountId32, poolId: u32, a: u128, inputAsset: TanglePrimitivesCurrencyCurrencyId, outputAsset: TanglePrimitivesCurrencyCurrencyId, inputAmount: u128, minOutputAmount: u128, balances: Vec<u128>, totalSupply: u128, outputAmount: u128], { swapper: AccountId32, poolId: u32, a: u128, inputAsset: TanglePrimitivesCurrencyCurrencyId, outputAsset: TanglePrimitivesCurrencyCurrencyId, inputAmount: u128, minOutputAmount: u128, balances: Vec<u128>, totalSupply: u128, outputAmount: u128 }>;
    ...
    tokenIssuer: {
       ...
       **/
      AddedToTransferList: AugmentedEvent<ApiType, [AccountId32, TanglePrimitivesCurrencyCurrencyId]>;
      /**
       ...
       **/
      RemovedFromIssueList: AugmentedEvent<ApiType, [AccountId32, TanglePrimitivesCurrencyCurrencyId]>;
      /**
       * Successful remove an account from the transfer whitelist. \[account, currency_id]\
       **/
      RemovedFromTransferList: AugmentedEvent<ApiType, [AccountId32, TanglePrimitivesCurrencyCurrencyId]>;
      /**
       * Token transferred success, \[origin, dest, currency_id, amount\]
       **/
      Transferred: AugmentedEvent<ApiType, [AccountId32, AccountId32, TanglePrimitivesCurrencyCurrencyId, u128]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    tokens: {
       ...
       * A balance was set by root.
       **/
      BalanceSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, free: u128, reserved: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, free: u128, reserved: u128 }>;
      /**
       * Deposited some balance into an account
       **/
      Deposited: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * An account was removed whose balance was non-zero but below
       * ExistentialDeposit, resulting in an outright loss.
       **/
      DustLost: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * An account was created with some free balance.
       **/
      Endowed: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128 }>;
      Issued: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, amount: u128 }>;
      /**
       * Some free balance was locked.
       **/
      Locked: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * Some locked funds were unlocked
       **/
      LockRemoved: AugmentedEvent<ApiType, [lockId: U8aFixed, currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32], { lockId: U8aFixed, currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32 }>;
      /**
       * Some funds are locked
       **/
      LockSet: AugmentedEvent<ApiType, [lockId: U8aFixed, currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128], { lockId: U8aFixed, currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128 }>;
      Rescinded: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, amount: u128 }>;
      /**
       * Some balance was reserved (moved from free to reserved).
       **/
      Reserved: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * Some reserved balance was repatriated (moved from reserved to
       * another account).
       **/
      ReserveRepatriated: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, from: AccountId32, to: AccountId32, amount: u128, status: FrameSupportTokensMiscBalanceStatus], { currencyId: TanglePrimitivesCurrencyCurrencyId, from: AccountId32, to: AccountId32, amount: u128, status: FrameSupportTokensMiscBalanceStatus }>;
      /**
       * Some balances were slashed (e.g. due to mis-behavior)
       **/
      Slashed: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, freeAmount: u128, reservedAmount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, freeAmount: u128, reservedAmount: u128 }>;
      /**
       * The total issuance of an currency has been set
       **/
      TotalIssuanceSet: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, amount: u128 }>;
      /**
       * Transfer succeeded.
       **/
      Transfer: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, from: AccountId32, to: AccountId32, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, from: AccountId32, to: AccountId32, amount: u128 }>;
      /**
       * Some locked balance was freed.
       **/
      Unlocked: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * Some balance was unreserved (moved from reserved to free).
       **/
      Unreserved: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * Some balances were withdrawn (e.g. pay for transaction fee)
       **/
      Withdrawn: AugmentedEvent<ApiType, [currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128], { currencyId: TanglePrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    xcmInterface: {
      ...
      XcmDestWeightAndFeeUpdated: AugmentedEvent<ApiType, [TanglePrimitivesXcmOperationType, TanglePrimitivesCurrencyCurrencyId, SpWeightsWeightV2Weight, u128]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    zenlinkStableAMM: {
       ...
       **/
      CollectProtocolFee: AugmentedEvent<ApiType, [poolId: u32, currencyId: TanglePrimitivesCurrencyCurrencyId, feeAmount: u128], { poolId: u32, currencyId: TanglePrimitivesCurrencyCurrencyId, feeAmount: u128 }>;
      /**
       * A pool was created.
       **/
      CreatePool: AugmentedEvent<ApiType, [poolId: u32, currencyIds: Vec<TanglePrimitivesCurrencyCurrencyId>, lpCurrencyId: TanglePrimitivesCurrencyCurrencyId, a: u128, account: AccountId32, adminFeeReceiver: AccountId32], { poolId: u32, currencyIds: Vec<TanglePrimitivesCurrencyCurrencyId>, lpCurrencyId: TanglePrimitivesCurrencyCurrencyId, a: u128, account: AccountId32, adminFeeReceiver: AccountId32 }>;
      /**
