...
declare module '@polkadot/types/lookup' {
    ...
    interface TangleKusamaRuntimeGovernanceOriginsCustomOriginsOrigin extends Enum {
        ...
        readonly type: 'WhitelistedCaller' | 'FellowshipAdmin' | 'ReferendumCanceller' | 'ReferendumKiller' | 'LiquidStaking' | 'SalpAdmin' | 'FellowshipInitiates' | 'Fellows' | 'FellowshipExperts' | 'FellowshipMasters' | 'Fellowship1Dan' | 'Fellowship2Dan' | 'Fellowship3Dan' | 'Fellowship4Dan' | 'Fellowship5Dan' | 'Fellowship6Dan' | 'Fellowship7Dan' | 'Fellowship8Dan' | 'Fellowship9Dan' | 'TechAdmin' | 'CoreAdmin' | 'TreasurySpend';
    }
    ...
    interface TanglePrimitivesCurrencyCurrencyId extends Enum {
        ...
        readonly asLpToken: ITuple<[TanglePrimitivesCurrencyTokenSymbol, u8, TanglePrimitivesCurrencyTokenSymbol, u8]>;
        ...
        readonly asLend: u8;
        readonly type: 'Native' | 'Lst' | 'Token' | 'Stable' | 'VsToken' | 'VsBond' | 'LpToken' | 'ForeignAsset' | 'Token2' | 'Lst2' | 'VsToken2' | 'VsBond2' | 'StableLpToken' | 'Blp' | 'Lend';
    }
    ...
    interface TangleAssetRegistryCall extends Enum {
        ...
        readonly type: 'RegisterNativeAsset' | 'UpdateNativeAsset' | 'RegisterTokenMetadata' | 'RegisterLstMetadata' | 'RegisterVstokenMetadata' | 'RegisterVsbondMetadata' | 'RegisterMultilocation' | 'ForceSetMultilocation';
    }
    ...
    interface TangleLstMintingCall extends Enum {
        ...
        readonly type: 'Mint' | 'Redeem' | 'Rebond' | 'RebondByUnlockId' | 'SetUnlockDuration' | 'SetMinimumMint' | 'SetMinimumRedeem' | 'AddSupportRebondToken' | 'RemoveSupportRebondToken' | 'SetFees' | 'SetHookIterationLimit' | 'SetUnlockingTotal' | 'SetMinTimeUnit' | 'RecreateCurrencyOngoingTimeUnit';
    }
    ...
    interface TangleSlpPrimitivesParachainStakingPrimitivesOneToManyLedger extends Struct {
        ...
        readonly requestBriefs: BTreeMap<StagingXcmV3MultiLocation, ITuple<[TanglePrimitivesTimeUnit, u128]>>;
    ...
    interface TangleXcmInterfaceCall extends Enum {
        ...
        readonly asUpdateXcmDestWeightAndFee: {
            readonly updates: Vec<ITuple<[TanglePrimitivesCurrencyCurrencyId, TanglePrimitivesXcmOperationType, SpWeightsWeightV2Weight, u128]>>;
        } & Struct;
    ...
    interface TanglePrimitivesXcmOperationType extends Enum {
        ...
        readonly type: 'UmpContributeTransact' | 'StatemineTransfer' | 'Bond' | 'WithdrawUnbonded' | 'BondExtra' | 'Unbond' | 'Rebond' | 'Delegate' | 'Payout' | 'Liquidize' | 'TransferBack' | 'TransferTo' | 'Chill' | 'Undelegate' | 'CancelLeave' | 'XtokensTransferBack' | 'ExecuteLeave' | 'ConvertAsset' | 'Vote' | 'RemoveVote' | 'Any' | 'SupplementaryFee';
    }
    ...
    interface TangleSlpxCall extends Enum {
        ...
        readonly type: 'Mint' | 'ZenlinkSwap' | 'Redeem' | 'StablePoolSwap' | 'AddWhitelist' | 'RemoveWhitelist' | 'SetExecutionFee' | 'SetTransferToFee' | 'SetCurrencyEthereumCallSwitch' | 'SetEthereumCallConfigration' | 'SetCurrencySupportXcmFee' | 'SetDelayBlock' | 'ForceAddOrder';
    }
    ...
    interface TangleStablePoolCall extends Enum {
        ...
        readonly asEditTokenRate: {
            readonly poolId: u32;
            readonly tokenRateInfo: Vec<ITuple<[TanglePrimitivesCurrencyCurrencyId, ITuple<[u128, u128]>]>>;
        } & Struct;
        ...
        readonly type: 'CreatePool' | 'AddLiquidity' | 'Swap' | 'RedeemProportion' | 'RedeemSingle' | 'RedeemMulti' | 'ModifyA' | 'ModifyFees' | 'ModifyRecipients' | 'EditTokenRate' | 'ConfigLstAutoRefresh' | 'RemoveLstAutoRefresh';
    }
    ...
    interface TangleLstVotingCall extends Enum {
        ...
        readonly type: 'Vote' | 'Unlock' | 'RemoveDelegatorVote' | 'KillReferendum' | 'AddDelegator' | 'SetReferendumStatus' | 'SetVoteLockingPeriod' | 'SetUndecidingTimeout' | 'NotifyVote' | 'NotifyRemoveDelegatorVote' | 'SetVoteCapRatio';
    }
    ...
    interface TangleTokenIssuerEvent extends Enum {
        ...
        readonly isTransferred: boolean;
        readonly asTransferred: ITuple<[AccountId32, AccountId32, TanglePrimitivesCurrencyCurrencyId, u128]>;
    ...
    interface TangleLstMintingEvent extends Enum {
        ...
        readonly type: 'Minted' | 'Redeemed' | 'RedeemSuccess' | 'Rebonded' | 'RebondedByUnlockId' | 'UnlockDurationSet' | 'MinimumMintSet' | 'MinimumRedeemSet' | 'SupportRebondTokenAdded' | 'SupportRebondTokenRemoved' | 'FeeSet' | 'HookIterationLimitSet' | 'UnlockingTotalSet' | 'MinTimeUnitSet' | 'FastRedeemFailed' | 'CurrencyTimeUnitRecreated';
    }
    ...
    interface TangleSlpEvent extends Enum {
        ...
        readonly type: 'DelegatorInitialized' | 'DelegatorBonded' | 'DelegatorBondExtra' | 'DelegatorUnbond' | 'DelegatorUnbondAll' | 'DelegatorRebond' | 'Delegated' | 'Undelegated' | 'Payout' | 'Liquidize' | 'Chill' | 'TransferBack' | 'TransferTo' | 'ConvertAsset' | 'DelegatorAdded' | 'DelegatorRemoved' | 'ValidatorsAdded' | 'ValidatorsRemoved' | 'Refund' | 'FundMoveFromExitToEntrance' | 'TimeUnitUpdated' | 'PoolTokenIncreased' | 'HostingFeeCharged' | 'PoolTokenDecreased' | 'FeeSupplemented' | 'ValidatorsByDelegatorSet' | 'OperateOriginSet' | 'FeeSourceSet' | 'DelegatorLedgerSet' | 'DelegatorLedgerQueryResponseConfirmed' | 'DelegatorLedgerQueryResponseFailed' | 'ValidatorsByDelegatorQueryResponseConfirmed' | 'ValidatorsByDelegatorQueryResponseFailed' | 'MinimumsMaximumsSet' | 'CurrencyDelaysSet' | 'HostingFeesSet' | 'CurrencyTuneExchangeRateLimitSet' | 'OngoingTimeUnitUpdateIntervalSet' | 'SupplementFeeAccountWhitelistAdded' | 'SupplementFeeAccountWhitelistRemoved' | 'ValidatorsReset' | 'ValidatorBoostListSet' | 'ValidatorBoostListAdded' | 'RemovedFromBoostList' | 'OutdatedValidatorBoostListCleaned' | 'BurnFeeFailed';
    }
    ...
    interface TangleSlpPrimitivesParachainStakingPrimitivesParachainStakingLedgerUpdateEntry extends Struct {
        readonly currencyId: TanglePrimitivesCurrencyCurrencyId;
        readonly delegatorId: StagingXcmV3MultiLocation;
    ...
    interface TangleSlpPrimitivesParachainStakingPrimitivesParachainStakingLedgerUpdateOperation extends Enum {
        readonly isBond: boolean;
    ...
    interface TangleSlpPrimitivesPolkadotPrimitivesSubstrateValidatorsByDelegatorUpdateEntry extends Struct {
        readonly currencyId: TanglePrimitivesCurrencyCurrencyId;
        readonly delegatorId: StagingXcmV3MultiLocation;
        readonly validators: Vec<StagingXcmV3MultiLocation>;
    }
    ...
    interface TangleXcmInterfaceEvent extends Enum {
        ...
        readonly asXcmDestWeightAndFeeUpdated: ITuple<[TanglePrimitivesXcmOperationType, TanglePrimitivesCurrencyCurrencyId, SpWeightsWeightV2Weight, u128]>;
    ...
    interface TangleSlpxEvent extends Enum {
        ...
        readonly type: 'AddWhitelistAccountId' | 'RemoveWhitelistAccountId' | 'XcmMint' | 'XcmMintFailed' | 'XcmZenlinkSwap' | 'XcmZenlinkSwapFailed' | 'XcmStablePoolSwap' | 'XcmStablePoolSwapFailed' | 'XcmRedeem' | 'XcmRedeemFailed' | 'SetTransferToFee' | 'SetExecutionFee' | 'SetCurrencyEthereumCallSwitch' | 'SetEthereumCallConfiguration' | 'XcmSetTokenAmount' | 'SetCurrencyToSupportXcmFee' | 'SetDelayBlock' | 'CreateOrder' | 'OrderHandled' | 'OrderFailed' | 'InsufficientAssets';
    }
    ...
    interface TangleStableAssetEvent extends Enum {
        ...
        readonly type: 'CreatePool' | 'LiquidityAdded' | 'TokenSwapped' | 'RedeemedProportion' | 'RedeemedSingle' | 'RedeemedMulti' | 'BalanceUpdated' | 'YieldCollected' | 'FeeCollected' | 'AModified' | 'FeeModified' | 'RecipientModified' | 'TokenRateSet' | 'TokenRateHardcapConfigured' | 'TokenRateHardcapRemoved' | 'TokenRateRefreshFailed';
    }
    ...
    interface TangleLstVotingEvent extends Enum {
        ...
        readonly type: 'Voted' | 'Unlocked' | 'DelegatorVoteRemoved' | 'DelegatorAdded' | 'ReferendumInfoCreated' | 'ReferendumInfoSet' | 'VoteLockingPeriodSet' | 'UndecidingTimeoutSet' | 'ReferendumKilled' | 'VoteNotified' | 'DelegatorVoteRemovedNotified' | 'ResponseReceived' | 'VoteCapRatioSet';
    }
    ...
    interface TangleXcmInterfaceError extends Enum {
        ...
        readonly isFailToConvert: boolean;
        readonly type: 'FeeConvertFailed' | 'XcmExecutionFailed' | 'XcmSendFailed' | 'OperationWeightAndFeeNotExist' | 'FailToConvert';
    }
    ...
    interface TangleSlpxError extends Enum {
        ...
        readonly isUnsupported: boolean;
        readonly type: 'TokenNotFoundInlstMinting' | 'TokenNotFoundInZenlink' | 'AccountIdAlreadyInWhitelist' | 'AccountIdNotInWhitelist' | 'ExceededWhitelistMaxNumber' | 'NotSetExecutionFee' | 'FreeBalanceTooLow' | 'ArgumentsError' | 'ErrorConvertlst' | 'ErrorValidating' | 'ErrorDelivering' | 'Unsupported';
    }
    ...
    interface TangleStableAssetError extends Enum {
        ...
        readonly type: 'InconsistentStorage' | 'InvalidPoolAsset' | 'ArgumentsMismatch' | 'ArgumentsError' | 'PoolNotFound' | 'Math' | 'InvalidPoolValue' | 'MintUnderMin' | 'SwapUnderMin' | 'RedeemUnderMin' | 'RedeemOverMax' | 'TokenRateNotCleared';
    }
    ...
    interface TangleStablePoolError extends Enum {
        ...
        readonly type: 'SwapUnderMin' | 'MintUnderMin' | 'CantMint' | 'RedeemOverMax' | 'TokenRateNotSet';
    }
    ...
    interface TangleLstVotingError extends Enum {
        ...
        readonly type: 'XcmFailure' | 'LstNotSupport' | 'DerivativeIndexOccupied' | 'PendingVote' | 'PendingUpdateReferendumStatus' | 'NoData' | 'NotOngoing' | 'NotCompleted' | 'NotKilled' | 'NotExpired' | 'NotVoter' | 'NoPermission' | 'NoPermissionYet' | 'AlreadyDelegating' | 'InsufficientFunds' | 'MaxVotesReached' | 'TooMany' | 'NotStandardVote' | 'InvalidConviction' | 'OutOfRange';
    }
