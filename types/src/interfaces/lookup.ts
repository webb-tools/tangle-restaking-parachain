...
export default {
  ...
  TangleXcmInterfaceCall: {
    _enum: {
      update_xcm_dest_weight_and_fee: {
        updates: 'Vec<(TanglePrimitivesCurrencyCurrencyId,TanglePrimitivesXcmOperationType,SpWeightsWeightV2Weight,u128)>',
      },
  ...
  TanglePrimitivesXcmOperationType: {
    _enum: ['UmpContributeTransact', 'StatemineTransfer', 'Bond', 'WithdrawUnbonded', 'BondExtra', 'Unbond', 'Rebond', 'Delegate', 'Payout', 'Liquidize', 'TransferBack', 'TransferTo', 'Chill', 'Undelegate', 'CancelLeave', 'XtokensTransferBack', 'ExecuteLeave', 'ConvertAsset', 'Vote', 'RemoveVote', 'Any', 'SupplementaryFee']
  },
  /**
  ...
  TangleSlpPrimitivesLedgerUpdateEntry: {
    _enum: {
      ...
      ParachainStaking: 'TangleSlpPrimitivesParachainStakingPrimitivesParachainStakingLedgerUpdateEntry'
    }
  },
  /**
  ...
  TangleSlpPrimitivesParachainStakingPrimitivesParachainStakingLedgerUpdateEntry: {
    ...
    updateOperation: 'TangleSlpPrimitivesParachainStakingPrimitivesParachainStakingLedgerUpdateOperation',
    amount: 'Compact<u128>',
    unlockTime: 'Option<TanglePrimitivesTimeUnit>'
  },
  /**
  ...
  TangleXcmInterfaceEvent: {
    _enum: {
      XcmDestWeightAndFeeUpdated: '(TanglePrimitivesXcmOperationType,TanglePrimitivesCurrencyCurrencyId,SpWeightsWeightV2Weight,u128)',
  ...
  TangleXcmInterfaceError: {
    _enum: ['FeeConvertFailed', 'XcmExecutionFailed', 'XcmSendFailed', 'OperationWeightAndFeeNotExist', 'FailToConvert']
  },
  /**
   ...
   **/
  TangleSlpxError: {
    _enum: ['TokenNotFoundInlstMinting', 'TokenNotFoundInZenlink', 'AccountIdAlreadyInWhitelist', 'AccountIdNotInWhitelist', 'ExceededWhitelistMaxNumber', 'NotSetExecutionFee', 'FreeBalanceTooLow', 'ArgumentsError', 'ErrorConvertlst', 'ErrorValidating', 'ErrorDelivering', 'Unsupported']
  },
  /**
  ...
  TangleStableAssetError: {
    _enum: ['InconsistentStorage', 'InvalidPoolAsset', 'ArgumentsMismatch', 'ArgumentsError', 'PoolNotFound', 'Math', 'InvalidPoolValue', 'MintUnderMin', 'SwapUnderMin', 'RedeemUnderMin', 'RedeemOverMax', 'TokenRateNotCleared']
  },
  /**
  ...
  TangleLstVotingError: {
    _enum: ['XcmFailure', 'lstNotSupport', 'DerivativeIndexOccupied', 'PendingVote', 'PendingUpdateReferendumStatus', 'NoData', 'NotOngoing', 'NotCompleted', 'NotKilled', 'NotExpired', 'NotVoter', 'NoPermission', 'NoPermissionYet', 'AlreadyDelegating', 'InsufficientFunds', 'MaxVotesReached', 'TooMany', 'NotStandardVote', 'InvalidConviction', 'OutOfRange']
  },
  /**
