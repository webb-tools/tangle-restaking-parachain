...
declare module '@polkadot/api-base/types/storage' {
	interface AugmentedQueries<ApiType extends ApiTypes> {
		assetRegistry: {
			...
			assetMetadatas: AugmentedQuery<
				...
				(
					arg:
						...
						| string
						| Uint8Array,
				) => Observable<Option<TangleAssetRegistryAssetMetadata>>,
				[TanglePrimitivesCurrencyAssetIds]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyAssetIds]>;
			/**
			 * The storages for MultiLocations.
			 *
			 * CurrencyIdToLocations: map CurrencyId => Option<MultiLocation>
			 **/
			currencyIdToLocations: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
			...
			currencyIdToWeights: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
			 ...
			 **/
			currencyMetadatas: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
			...
			locationToCurrencyIds: AugmentedQuery<
				...
				) => Observable<Option<TanglePrimitivesCurrencyCurrencyId>>,
				[StagingXcmV3MultiLocation]
			> &
			 ...
			 **/
			nextForeignAssetId: AugmentedQuery<ApiType, () => Observable<u32>, []> &
			 ...
			 * NextTokenId: TokenId
			 **/
			nextTokenId: AugmentedQuery<ApiType, () => Observable<u8>, []> &
				QueryableStorageEntry<ApiType, []>;
			/**
			 * Generic query
			 **/
		...
		fellowshipCollective: {
			...
			members: AugmentedQuery<
				...
				) => Observable<Option<PalletRankedCollectiveMemberRecord>>,
				[AccountId32]
			> &
				QueryableStorageEntry<ApiType, [AccountId32]>;
			/**
		...
		LstMinting: {
			...
			minTimeUnit: AugmentedQuery<
				...
				(
					arg:
						...
						| string
						| Uint8Array,
				) => Observable<TanglePrimitivesTimeUnit>,
				[TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			ongoingTimeUnit: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
						...
						| string
						| Uint8Array,
				) => Observable<Option<TanglePrimitivesTimeUnit>>,
				[TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			timeUnitUnlockLedger: AugmentedQuery<
				ApiType,
				(
					arg1:
						| TanglePrimitivesTimeUnit
					...
					arg2:
						...
						| string
						| Uint8Array,
				) => Observable<Option<ITuple<[u128, Vec<u32>, TanglePrimitivesCurrencyCurrencyId]>>>,
				[TanglePrimitivesTimeUnit, TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<
					ApiType,
					[TanglePrimitivesTimeUnit, TanglePrimitivesCurrencyCurrencyId]
				>;
			tokenPool: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
			...
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			tokenUnlockLedger: AugmentedQuery<
				ApiType,
				(
					arg1:
						| TanglePrimitivesCurrencyCurrencyId
					...
					Option<ITuple<[AccountId32, u128, TanglePrimitivesTimeUnit, TanglePrimitivesRedeemType]>>
				>,
				[TanglePrimitivesCurrencyCurrencyId, u32]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId, u32]>;
			...
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			userUnlockLedger: AugmentedQuery<
				ApiType,
				(
					arg1: AccountId32 | string | Uint8Array,
					arg2:
						...
						| string
						| Uint8Array,
				) => Observable<Option<ITuple<[u128, Vec<u32>]>>>,
				[AccountId32, TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [AccountId32, TanglePrimitivesCurrencyCurrencyId]>;
			/**
			 * Generic query
			 **/
			[key: string]: QueryableStorageEntry<ApiType>;
		...
		LstVoting: {
			...
			classLocksFor: AugmentedQuery<
				...
				(
					arg: AccountId32 | string | Uint8Array,
				) => Observable<Vec<ITuple<[TanglePrimitivesCurrencyCurrencyId, u128]>>>,
				[AccountId32]
			> &
				QueryableStorageEntry<ApiType, [AccountId32]>;
			...
			delegatorVotes: AugmentedQuery<
				...
				(
					arg1:
						...
						| Uint8Array,
					arg2: u32 | AnyNumber | Uint8Array,
				) => Observable<Vec<ITuple<[u16, TangleLstVotingVoteAccountVote]>>>,
				[TanglePrimitivesCurrencyCurrencyId, u32]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId, u32]>;
			pendingDelegatorVotes: AugmentedQuery<
				ApiType,
				(
					arg1:
						| TanglePrimitivesCurrencyCurrencyId
			...
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId, u32]>;
			pendingReferendumInfo: AugmentedQuery<
				ApiType,
				(
					arg: u64 | AnyNumber | Uint8Array,
				) => Observable<Option<ITuple<[TanglePrimitivesCurrencyCurrencyId, u32]>>>,
				[u64]
			> &
				QueryableStorageEntry<ApiType, [u64]>;
			pendingRemoveDelegatorVote: AugmentedQuery<
				ApiType,
				(
					arg: u64 | AnyNumber | Uint8Array,
				) => Observable<Option<ITuple<[TanglePrimitivesCurrencyCurrencyId, u32, u16]>>>,
				[u64]
			> &
				QueryableStorageEntry<ApiType, [u64]>;
			pendingVotingInfo: AugmentedQuery<
				ApiType,
				(
					arg: u64 | AnyNumber | Uint8Array,
				) => Observable<
					Option<
						ITuple<
							[
								...
								u16,
								AccountId32,
								Option<ITuple<[TangleLstVotingVoteAccountVote, u128]>>,
							]
						>
					>
				>,
			...
			referendumInfoFor: AugmentedQuery<
				...
				(
					arg1:
						...
						| Uint8Array,
					arg2: u32 | AnyNumber | Uint8Array,
				) => Observable<Option<TangleLstVotingVoteReferendumInfo>>,
				[TanglePrimitivesCurrencyCurrencyId, u32]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId, u32]>;
			referendumTimeout: AugmentedQuery<
				ApiType,
				(
					arg: u32 | AnyNumber | Uint8Array,
				) => Observable<Vec<ITuple<[TanglePrimitivesCurrencyCurrencyId, u32]>>>,
				[u32]
			> &
				QueryableStorageEntry<ApiType, [u32]>;
			undecidingTimeout: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
			...
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			voteDelegatorFor: AugmentedQuery<
				ApiType,
				(
					arg1: AccountId32 | string | Uint8Array,
					arg2:
				...
				[AccountId32, TanglePrimitivesCurrencyCurrencyId, u32]
			> &
				QueryableStorageEntry<ApiType, [AccountId32, TanglePrimitivesCurrencyCurrencyId, u32]>;
			voteLockingPeriod: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
			...
			votingFor: AugmentedQuery<
				ApiType,
				(arg: AccountId32 | string | Uint8Array) => Observable<TangleLstVotingVoteVoting>,
				[AccountId32]
			> &
				QueryableStorageEntry<ApiType, [AccountId32]>;
			/**
		...
		merkleDistributor: {
			claimedBitMap: AugmentedQuery<
				ApiType,
				(arg1: u32 | AnyNumber | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<u32>,
				[u32, u32]
			> &
			 ...
			 **/
			createWhiteSet: AugmentedQuery<ApiType, () => Observable<BTreeSet<AccountId32>>, []> &
				QueryableStorageEntry<ApiType, []>;
			merkleDistributorMetadata: AugmentedQuery<
				ApiType,
				(arg: u32 | AnyNumber | Uint8Array) => Observable<Option<MerkleDistributorMerkleMetadata>>,
				[u32]
			> &
				QueryableStorageEntry<ApiType, [u32]>;
			nextMerkleDistributorId: AugmentedQuery<ApiType, () => Observable<u32>, []> &
				QueryableStorageEntry<ApiType, []>;
			/**
			 * Generic query
			 **/
		...
		oracle: {
			 ...
			 **/
			hasDispatched: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> &
				QueryableStorageEntry<ApiType, []>;
			/**
		...
		parachainStaking: {
			...
			atStake: AugmentedQuery<
				...
				(
					arg1: u32 | AnyNumber | Uint8Array,
					arg2: AccountId32 | string | Uint8Array,
				) => Observable<TangleParachainStakingCollatorSnapshot>,
				[u32, AccountId32]
			> &
				QueryableStorageEntry<ApiType, [u32, AccountId32]>;
			/**
			...
			bottomDelegations: AugmentedQuery<
				...
				(
					arg: AccountId32 | string | Uint8Array,
				) => Observable<Option<TangleParachainStakingDelegations>>,
				[AccountId32]
			> &
				QueryableStorageEntry<ApiType, [AccountId32]>;
			/**
			...
			candidateInfo: AugmentedQuery<
				...
				(
					arg: AccountId32 | string | Uint8Array,
				) => Observable<Option<TangleParachainStakingCandidateMetadata>>,
				[AccountId32]
			> &
				QueryableStorageEntry<ApiType, [AccountId32]>;
			/**
			...
			candidatePool: AugmentedQuery<
				ApiType,
				() => Observable<Vec<TangleParachainStakingBond>>,
				[]
			> &
				QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 **/
			collatorReserveToLockMigrations: AugmentedQuery<
				ApiType,
			...
			delayedPayouts: AugmentedQuery<
				...
				(
					arg: u32 | AnyNumber | Uint8Array,
				) => Observable<Option<TangleParachainStakingDelayedPayout>>,
				[u32]
			> &
				QueryableStorageEntry<ApiType, [u32]>;
			/**
			...
			delegationScheduledRequests: AugmentedQuery<
				...
				(
					arg: AccountId32 | string | Uint8Array,
				) => Observable<Vec<TangleParachainStakingDelegationRequestsScheduledRequest>>,
				[AccountId32]
			> &
				QueryableStorageEntry<ApiType, [AccountId32]>;
			/**
			 ...
			 **/
			delegatorReserveToLockMigrations: AugmentedQuery<
				ApiType,
				(arg: AccountId32 | string | Uint8Array) => Observable<bool>,
				[AccountId32]
			> &
			...
			delegatorState: AugmentedQuery<
				...
				(
					arg: AccountId32 | string | Uint8Array,
				) => Observable<Option<TangleParachainStakingDelegator>>,
				[AccountId32]
			> &
				QueryableStorageEntry<ApiType, [AccountId32]>;
			/**
			...
			inflationConfig: AugmentedQuery<
				ApiType,
				() => Observable<TangleParachainStakingInflationInflationInfo>,
				[]
			> &
				QueryableStorageEntry<ApiType, []>;
			/**
			...
			parachainBondInfo: AugmentedQuery<
				ApiType,
				() => Observable<TangleParachainStakingParachainBondConfig>,
				[]
			> &
				QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 **/
			round: AugmentedQuery<ApiType, () => Observable<TangleParachainStakingRoundInfo>, []> &
				QueryableStorageEntry<ApiType, []>;
			/**
		...
		prices: {
			 ...
			 **/
			foreignToNativeAsset: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
		...
		session: {
			...
			nextKeys: AugmentedQuery<
				...
				(
					arg: AccountId32 | string | Uint8Array,
				) => Observable<Option<TangleKusamaRuntimeSessionKeys>>,
				[AccountId32]
			> &
				QueryableStorageEntry<ApiType, [AccountId32]>;
			/**
			...
			queuedKeys: AugmentedQuery<
				ApiType,
				() => Observable<Vec<ITuple<[AccountId32, TangleKusamaRuntimeSessionKeys]>>>,
				[]
			> &
				QueryableStorageEntry<ApiType, []>;
			/**
		...
		slp: {
			...
			currencyDelays: AugmentedQuery<
				...
				(
					arg:
						...
						| string
						| Uint8Array,
				) => Observable<Option<TangleSlpPrimitivesDelays>>,
				[TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			/**
			...
			currencyLatestTuneRecord: AugmentedQuery<
				...
				(
					arg:
						...
						| string
						| Uint8Array,
				) => Observable<Option<ITuple<[TanglePrimitivesTimeUnit, u32]>>>,
				[TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			/**
			...
			currencyTuneExchangeRateLimit: AugmentedQuery<
				...
				(
					arg:
						...
						| string
						| Uint8Array,
				) => Observable<Option<ITuple<[u32, Permill]>>>,
				[TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			/**
			 ...
			 * is unaccepted.
			 **/
			delegationsOccupied: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
			 ...
			 **/
			delegatorLatestTuneRecord: AugmentedQuery<
				ApiType,
				(
					arg1:
						| TanglePrimitivesCurrencyCurrencyId
						...
						| string
						| Uint8Array,
					arg2: StagingXcmV3MultiLocation | { parents?: any; interior?: any } | string | Uint8Array,
				) => Observable<Option<TanglePrimitivesTimeUnit>>,
			 ...
			 **/
			delegatorLedgers: AugmentedQuery<
				ApiType,
				(
					arg1:
						| TanglePrimitivesCurrencyCurrencyId
						...
						| Uint8Array,
					arg2: StagingXcmV3MultiLocation | { parents?: any; interior?: any } | string | Uint8Array,
				) => Observable<Option<TangleSlpPrimitivesLedger>>,
				[TanglePrimitivesCurrencyCurrencyId, StagingXcmV3MultiLocation]
			> &
				QueryableStorageEntry<
					ApiType,
					[TanglePrimitivesCurrencyCurrencyId, StagingXcmV3MultiLocation]
				>;
			delegatorLedgerXcmUpdateQueue: AugmentedQuery<
				ApiType,
				(
					arg: u64 | AnyNumber | Uint8Array,
				) => Observable<Option<ITuple<[TangleSlpPrimitivesLedgerUpdateEntry, u32]>>>,
				[u64]
			> &
				QueryableStorageEntry<ApiType, [u64]>;
			/**
			 ...
			 **/
			delegatorNextIndex: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
			 ...
			 **/
			delegatorsIndex2Multilocation: AugmentedQuery<
				ApiType,
				(
					arg1:
						| TanglePrimitivesCurrencyCurrencyId
				...
				[TanglePrimitivesCurrencyCurrencyId, u16]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId, u16]>;
			/**
			 * Delegators in service. Currency Id + MultiLocation => Sub-account index
			 **/
			delegatorsMultilocation2Index: AugmentedQuery<
				ApiType,
				(
					arg1:
						| TanglePrimitivesCurrencyCurrencyId
			...
			feeSources: AugmentedQuery<
				...
				(
					arg:
						...
						| string
						| Uint8Array,
				) => Observable<Option<ITuple<[StagingXcmV3MultiLocation, u128]>>>,
				[TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			/**
			...
			hostingFees: AugmentedQuery<
				...
				(
					arg:
						...
						| string
						| Uint8Array,
				) => Observable<Option<ITuple<[Permill, StagingXcmV3MultiLocation]>>>,
				[TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			lastTimeUpdatedOngoingTimeUnit: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
			...
			minimumsAndMaximums: AugmentedQuery<
				...
				(
					arg:
						...
						| string
						| Uint8Array,
				) => Observable<Option<TangleSlpPrimitivesMinimumsMaximums>>,
				[TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			ongoingTimeUnitUpdateInterval: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
			...
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			supplementFeeAccountWhitelist: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
						...
						| string
						| Uint8Array,
				) => Observable<Option<Vec<ITuple<[StagingXcmV3MultiLocation, H256]>>>>,
				[TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			/**
			...
			validatorBoostList: AugmentedQuery<
				...
				(
					arg:
						...
						| string
						| Uint8Array,
				) => Observable<Option<Vec<ITuple<[StagingXcmV3MultiLocation, u32]>>>>,
				[TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			/**
			...
			validators: AugmentedQuery<
				...
				(
					arg:
						...
						| string
						| Uint8Array,
				) => Observable<Option<Vec<StagingXcmV3MultiLocation>>>,
				[TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			/**
			 ...
			 **/
			validatorsByDelegator: AugmentedQuery<
				ApiType,
				(
					arg1:
						| TanglePrimitivesCurrencyCurrencyId
			...
			> &
				QueryableStorageEntry<
					...
					[TanglePrimitivesCurrencyCurrencyId, StagingXcmV3MultiLocation]
				>;
			validatorsByDelegatorXcmUpdateQueue: AugmentedQuery<
				ApiType,
				(
					arg: u64 | AnyNumber | Uint8Array,
				) => Observable<Option<ITuple<[TangleSlpPrimitivesValidatorsByDelegatorUpdateEntry, u32]>>>,
				[u64]
			> &
				QueryableStorageEntry<ApiType, [u64]>;
			/**
		...
		slpx: {
			currencyIdList: AugmentedQuery<
				ApiType,
				() => Observable<Vec<TanglePrimitivesCurrencyCurrencyId>>,
				[]
			> &
				QueryableStorageEntry<ApiType, []>;
			delayBlock: AugmentedQuery<ApiType, () => Observable<u32>, []> &
				QueryableStorageEntry<ApiType, []>;
			/**
			 * Charge corresponding fees for different CurrencyId
			 **/
			executionFee: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
			...
			> &
				QueryableStorageEntry<ApiType, [TanglePrimitivesCurrencyCurrencyId]>;
			orderQueue: AugmentedQuery<ApiType, () => Observable<Vec<TangleSlpxOrder>>, []> &
				QueryableStorageEntry<ApiType, []>;
			supportXcmFeeList: AugmentedQuery<
				ApiType,
				() => Observable<Vec<TanglePrimitivesCurrencyCurrencyId>>,
				[]
			> &
			...
			transferToFee: AugmentedQuery<
				...
				[TangleSlpxSupportChain]
			> &
				QueryableStorageEntry<ApiType, [TangleSlpxSupportChain]>;
			/**
			 * Contract whitelist
			 **/
			whitelistAccountId: AugmentedQuery<
				ApiType,
				(
					arg:
						| TangleSlpxSupportChain
			...
			> &
				QueryableStorageEntry<ApiType, [TangleSlpxSupportChain]>;
			xcmEthereumCallConfiguration: AugmentedQuery<
				ApiType,
				() => Observable<Option<TangleSlpxEthereumCallConfiguration>>,
				[]
			> &
				QueryableStorageEntry<ApiType, []>;
			/**
		...
		stableAsset: {
			...
			pools: AugmentedQuery<
				...
				(
					arg: u32 | AnyNumber | Uint8Array,
				) => Observable<Option<TangleStableAssetStableAssetPoolInfo>>,
				[u32]
			> &
				QueryableStorageEntry<ApiType, [u32]>;
			tokenRateCaches: AugmentedQuery<
				ApiType,
				(
					arg1: u32 | AnyNumber | Uint8Array,
					arg2:
				...
				[u32, TanglePrimitivesCurrencyCurrencyId]
			> &
				QueryableStorageEntry<ApiType, [u32, TanglePrimitivesCurrencyCurrencyId]>;
			tokenRateHardcap: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
		...
		tokenIssuer: {
			 ...
			 **/
			transferWhiteList: AugmentedQuery<
				ApiType,
				(
					arg:
						| TanglePrimitivesCurrencyCurrencyId
		...
		unknownTokens: {
			...
			abstractFungibleBalances: AugmentedQuery<
				ApiType,
				(
					arg1: StagingXcmV3MultiLocation | { parents?: any; interior?: any } | string | Uint8Array,
					arg2: Bytes | string | Uint8Array,
				) => Observable<u128>,
				[StagingXcmV3MultiLocation, Bytes]
			> &
				QueryableStorageEntry<ApiType, [StagingXcmV3MultiLocation, Bytes]>;
			/**
			...
			> &
				QueryableStorageEntry<ApiType, [StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]>;
			/**
			 * Generic query
			 **/
			[key: string]: QueryableStorageEntry<ApiType>;
		...
		xcmInterface: {
			 ...
			 **/
			xcmWeightAndFee: AugmentedQuery<
				ApiType,
				(
					arg1:
						| TanglePrimitivesCurrencyCurrencyId
					...
					arg2:
						...
						| number
						| Uint8Array,
				) => Observable<Option<ITuple<[SpWeightsWeightV2Weight, u128]>>>,
				[TanglePrimitivesCurrencyCurrencyId, TanglePrimitivesXcmOperationType]
			> &
				QueryableStorageEntry<
					ApiType,
					[TanglePrimitivesCurrencyCurrencyId, TanglePrimitivesXcmOperationType]
		...
		zenlinkProtocol: {
			 ...
			 **/
			bootstrapEndStatus: AugmentedQuery<
				ApiType,
				(
					arg:
						| ITuple<[ZenlinkProtocolPrimitivesAssetId, ZenlinkProtocolPrimitivesAssetId]>
						| [
								(
									| ZenlinkProtocolPrimitivesAssetId
				...
				) => Observable<ZenlinkProtocolPrimitivesPairStatus>,
				[ITuple<[ZenlinkProtocolPrimitivesAssetId, ZenlinkProtocolPrimitivesAssetId]>]
			> &
				QueryableStorageEntry<
					ApiType,
					[ITuple<[ZenlinkProtocolPrimitivesAssetId, ZenlinkProtocolPrimitivesAssetId]>]
				>;
			bootstrapLimits: AugmentedQuery<
				ApiType,
				(
					arg:
						| ITuple<[ZenlinkProtocolPrimitivesAssetId, ZenlinkProtocolPrimitivesAssetId]>
				...
				) => Observable<BTreeMap<ZenlinkProtocolPrimitivesAssetId, u128>>,
				[ITuple<[ZenlinkProtocolPrimitivesAssetId, ZenlinkProtocolPrimitivesAssetId]>]
			> &
				QueryableStorageEntry<
					ApiType,
					[ITuple<[ZenlinkProtocolPrimitivesAssetId, ZenlinkProtocolPrimitivesAssetId]>]
				>;
			bootstrapPersonalSupply: AugmentedQuery<
				ApiType,
				(
					arg:
						| ITuple<
			...
			> &
				...
				>;
			bootstrapRewards: AugmentedQuery<
				ApiType,
				(
					arg:
						| ITuple<[ZenlinkProtocolPrimitivesAssetId, ZenlinkProtocolPrimitivesAssetId]>
			 ...
			 **/
			feeMeta: AugmentedQuery<ApiType, () => Observable<ITuple<[Option<AccountId32>, u8]>>, []> &
				QueryableStorageEntry<ApiType, []>;
			/**
			 * Foreign foreign storage
			 * The number of units of assets held by any given account.
			 **/
			foreignLedger: AugmentedQuery<
				ApiType,
				(
					arg:
						| ITuple<[ZenlinkProtocolPrimitivesAssetId, AccountId32]>
						| [
								(
									| ZenlinkProtocolPrimitivesAssetId
									| { chainId?: any; assetType?: any; assetIndex?: any }
				...
				[ITuple<[ZenlinkProtocolPrimitivesAssetId, AccountId32]>]
			> &
				QueryableStorageEntry<ApiType, [ITuple<[ZenlinkProtocolPrimitivesAssetId, AccountId32]>]>;
			foreignList: AugmentedQuery<
				ApiType,
				() => Observable<Vec<ZenlinkProtocolPrimitivesAssetId>>,
				[]
			> &
				QueryableStorageEntry<ApiType, []>;
			/**
			...
			liquidityPairs: AugmentedQuery<
				...
				) => Observable<Option<ZenlinkProtocolPrimitivesAssetId>>,
				[ITuple<[ZenlinkProtocolPrimitivesAssetId, ZenlinkProtocolPrimitivesAssetId]>]
			> &
				QueryableStorageEntry<
					ApiType,
		...
		zenlinkStableAMM: {
			...
			pools: AugmentedQuery<
				ApiType,
				(arg: u32 | AnyNumber | Uint8Array) => Observable<Option<ZenlinkStableAmmPrimitivesPool>>,
				[u32]
			> &
				QueryableStorageEntry<ApiType, [u32]>;
			/**
