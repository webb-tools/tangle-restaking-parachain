...
//! Autogenerated weights for `tangle_currencies`
//!
...
// --heap-pages=4096
// --header=./HEADER-GPL3
// --output=./runtime/asgard/src/weights/tangle_currencies.rs
...
/// Weight functions for tangle_currencies.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> tangle_currencies::WeightInfo for WeightInfo<T> {
