...
impl tangle_parachain_staking::Config for Runtime {
	...
	type OnNewRound = ();
	type WeightInfo = tangle_parachain_staking::weights::SubstrateWeight<Runtime>;
}
...
/// Configure the pallet tangle_stable_asset in pallets/tangle_stable_asset.
...
construct_runtime! {
	pub enum Runtime {
		...
		ParachainStaking: tangle_parachain_staking = 25,
