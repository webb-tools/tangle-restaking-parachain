...
pub mod currency {
	...
	pub const TNT: Balance = 1_000_000_000_000_000_000;
	pub const DOLLARS: Balance = TNT;
	...
	pub const MILLITNT: Balance = 1_000_000_000;
	pub const MICROTNT: Balance = 1_000_000;
...
/// Time.
pub mod time {
	use tangle_primitives::{BlockNumber, Moment};
