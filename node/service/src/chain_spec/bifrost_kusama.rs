...
use tangle_primitives::{CurrencyId, CurrencyId::*, TokenInfo, TokenSymbol::*};
...
pub fn local_testnet_config() -> ChainSpec {
	...
	ChainSpec::builder(
		tangle_kusama_runtime::WASM_BINARY.expect("WASM binary was not built, please build it!"),
		RelayExtensions { relay_chain: "kusama-local".into(), para_id: PARA_ID },
	)
	.with_name("Bifrost Local Testnet")
	.with_id("tangle_local_testnet")
	.with_chain_type(ChainType::Local)
	.with_genesis_config_patch(tangle_genesis(
		vec![
			(
				get_account_id_from_seed::<sr25519::Public>("Alice"),
	...
	.with_properties(tangle_kusama_properties())
