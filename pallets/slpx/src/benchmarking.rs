...
use tangle_asset_registry::CurrencyIdToLocations;
use tangle_primitives::{CurrencyId, KSM, VKSM};

fn init_whitelist<T: Config + tangle_asset_registry::Config>() -> (T::AccountId, H160) {
...
#[benchmarks(where  T: Config + tangle_asset_registry::Config + tangle_stable_pool::Config + tangle_stable_asset::Config + orml_tokens::Config<CurrencyId = CurrencyId>)]
mod benchmarks {
	use super::*;
