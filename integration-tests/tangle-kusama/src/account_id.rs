...
pub const tangle_CROWDLOAN_ID: PalletId = PalletId(*b"bf/salp#");
pub const tangle_SALP_LITE_CROWDLOAN_ID: PalletId = PalletId(*b"bf/salpl");
...
pub const tangle_VSBOND_PALLET_ID: PalletId = PalletId(*b"bf/salpb");
